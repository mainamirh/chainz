        ...
        >
          ...
          <td>
            <div className="flex items-center gap-2">
              ...
              <div className="h-[20px] w-[80px] rounded-sm bg-border" />
            </div>
          </td>
          <td>
            <div className="mr-auto h-[22px] w-4/5 rounded-sm bg-border" />
          </td>
          <td>
            <div className="ml-auto h-[22px] w-4/5 rounded-sm bg-border" />
          </td>
          <td>
            <div className="ml-auto h-[22px] w-4/5 rounded-sm bg-border" />
          </td>
...
export const RecommendationSK = () => {
  return (
    <div className="flex w-[340px] shrink-0 flex-col gap-3 rounded-xl border border-border bg-foreground p-5 shadow-md">
      <div className="h-[15px] w-[66px] animate-pulse rounded-sm bg-border" />

      <div className="flex animate-pulse items-center justify-between">
        <div className="h-[35px] w-[132px] rounded-sm bg-border" />

        <div className="h-[15px] w-[65px] rounded-sm bg-border" />
      </div>

      <div className="h-[16px] animate-pulse rounded-sm bg-border" />

      <div className="h-[20px] w-1/2 animate-pulse rounded-sm bg-border" />
    </div>
  );
};
